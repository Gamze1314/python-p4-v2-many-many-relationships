...
class Employee(db.Model):
    ...
    # assignent model created ;maps the employee to related assignments.
    assignments = db.relationship(
        'Assignment', back_populates='employee', cascade='all, delete-orphan')  # this will create a new relationship in the Assignment model.
...
class Meeting(db.Model):
    ...
    # Relationship mapping the meeting to related employees-MANY TO MANY between employee and meeting.
